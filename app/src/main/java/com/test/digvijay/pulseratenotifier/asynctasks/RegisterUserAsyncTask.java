...
public class RegisterUserAsyncTask extends AsyncTask<String, String, String> {

    private static final String TAG = RegisterUserAsyncTask.class.toString();
    ...
    public RegisterUserAsyncTask(Map<String, String> urlParams, AsyncResponse delegate) {
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            URL url = new URL(ServerConstants.LOCAL_URL + "/createuser");
    ...
    protected void onPostExecute(String result) {
        Log.i(TAG, "User Registered, result: " + result);
