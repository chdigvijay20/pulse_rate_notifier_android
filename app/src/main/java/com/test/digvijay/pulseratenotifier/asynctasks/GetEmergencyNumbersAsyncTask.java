...
public class GetEmergencyNumbersAsyncTask extends AsyncTask<String, String, String> {

    private static final String TAG = GetEmergencyNumbersAsyncTask.class.toString();
    ...
    public GetEmergencyNumbersAsyncTask(Map<String, String> urlParams, AsyncResponse delegate) {
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            URL url = new URL(ServerConstants.LOCAL_URL + "/getemergencydata");
