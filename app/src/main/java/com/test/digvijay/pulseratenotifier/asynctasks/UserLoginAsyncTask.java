...
public class UserLoginAsyncTask extends AsyncTask<String, String, String> {
    ...
    private static final String LOG_TAG = UserLoginAsyncTask.class.toString();
    ...
    public UserLoginAsyncTask(Map<String, String> urlParams, AsyncResponse delegate) {
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            URL url = new URL(ServerConstants.LOCAL_URL + "/userlogin");
    ...
    protected void onPostExecute(String result) {
        Log.i(LOG_TAG, "User Login, result: " + result);
