...
public class GetNormalRestingHeartRateAsyncTask extends AsyncTask<String, String, String> {

    private static final String LOG_TAG = "NormalHeartRateAsyncT";
    ...
    public GetNormalRestingHeartRateAsyncTask(Map urlParams, AsyncResponse delegate) {
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            URL url = new URL(ServerConstants.LOCAL_URL + "/getnormalrestingheartrate");
    ...
    protected void onPostExecute(String result) {
        Log.i(LOG_TAG, "Normal Heart Rate, result: " + result);
